    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form  class="form-horizontal" name="nuevo" action="prog3.php?id=<?php echo $id ?>" method="post" >
                    <div class="form-group">
                        <label class="col-md-2 control-label">Nombres:</label>
                        <div class="col-md-8">
                            <div class="input-group">
                                <?php echo $rowp['nombres'] ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <a href="prog3.php?id=<?php echo $id ?>" class="btn-danger btn"><i class="fa fa-trash-o"></i> Eliminar</a>
