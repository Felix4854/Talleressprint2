...
<li><a href="?view=usuario">Inicio</a></li>
<li>Administración</li>
<li class="active"><a href="?view=usuario">Gestión de Usuarios</a></li>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p class="mb20">Llene los campos para crear una nueva contraseña</p>
                <form  class="form-horizontal" name="nuevo" action="usuarios.php" method="post" >
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control"  placeholder="Contraseña" name="passa">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" placeholder="Confirmar Contraseña" name="passb">
                            </div>
                        </div>
                    </div>
