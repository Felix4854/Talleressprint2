            ...
            <div class="panel-body">
                <div class="tab-content">
                    <div class="tab-pane active" id="dominfotiles">
                        <div class="row">
                            <div class="col-md-6">
                                <a class="info-tile tile-sky" href="disciplina.php">
                                    <div class="tile-heading">
                                        <div class="pull-left"></div>
                                        <div class="pull-right"></div>
                                    </div>
                                    <div class="tile-body">
                                        <div class="pull-left"><i class="fa fa-book"></i></div>
                                        <div class="pull-right">Gestion de Disciplinas</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="info-tile tile-orange" href="profesor.php">
                                    <div class="tile-heading">
                                        <div class="pull-left"></div>
                                        <div class="pull-right"></div>
                                    </div>
                                    <div class="tile-body">
                                        <div class="pull-left"><i class="fa fa-mortar-board"></i></div>
                                        <div class="pull-right">Gestión de Profesores</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="info-tile tile-brown" href="aula.php">
                                    <div class="tile-heading">
                                        <div class="pull-left"></div>
                                        <div class="pull-right"></div>
                                    </div>
                                    <div class="tile-body">
                                        ...
                                        <div class="pull-right">Gestión de Ubicación</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="info-tile tile-midnightblue" href="talleres.php">
                                    <div class="tile-heading">
                                        <div class="pull-left"></div>
                                        <div class="pull-right"></div>
                                    </div>
                                    <div class="tile-body">
                                        <div class="pull-left"><i class="fa fa-book"></i></div>
                                        <div class="pull-right">Gestión de Talleres</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <a class="info-tile tile-purple" href="alumnos.php">
                                    <div class="tile-heading">
                                        <div class="pull-left"></div>
                                        <div class="pull-right"></div>
                                    </div>
                                    <div class="tile-body">
                                        ...
                                        <div class="pull-right">Gestión de Alumnos</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="info-tile tile-success" href="usuarios.php">
                                    <div class="tile-heading">
                                        <div class="pull-left"></div>
                                        <div class="pull-right"></div>
                                    </div>
                                    <div class="tile-body">
                                        ...
                                        <div class="pull-right">Gestión de Usuarios</div>
                                    </div>
                                </a>
                            </div>
