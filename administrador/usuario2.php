<?php 
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de editar usuario: ".$row['nombre']);
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  class="form-horizontal" name="nuevo" action="usug2.php?id=<?php echo $id ?>" method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="password" class="form-control"  placeholder="Contraseña" name="pass" value="<?php echo $row['pass']?>">
                            </div>
                        </div>
                    </div>
