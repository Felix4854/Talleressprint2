<?php 
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de editar los datos del profesor: ". $rowp['nombres'] );
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
...
<!-- fin de cabecera -->
    ...
    <div class="page-heading">            
        <h1><i class="fa fa-mortar-board"></i> Gestión de Profesores</h1>
        <div class="options">
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form  class="form-horizontal" name="nuevo" action="prog2.php?id=<?php echo $id ?>" method="post" >
                    <div class="form-group">
                        <label class="col-md-2 control-label">Nombres:</label>
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" class="form-control"  name="nombre" value="<?php echo $rowp['nombres'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" class="form-control"  name="correo" value="<?php echo $rowp['correo'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" class="form-control"  name="usuario" value="<?php echo $rowp['usuario'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="password" class="form-control"  name="pass" value="<?php echo $rowp['pass'] ?>">
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <a href="profesor.php" class="btn-default btn"><i class="fa fa-mail-reply"></i> Cancelar</a>
                        </div>
                    </div>
                </div>
                </form>
