<?php 
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de profesores" );
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
    ...
    <div class="page-heading">            
        ...
        <div class="options">
            <div class="btn-toolbar">              
                <a href="profesor1.php" class="btn btn-success"><i class="fa fa-plus-circle"></i> NUEVO PROFESOR</a>
            </div>
        </div>
    </div>
...
<?php if (isset($_GET['r']) AND $_GET['r']==1){ ?>                                    
    <div class="alert alert-dismissable alert-success">
        <i class="fa fa-fw fa-check"></i>&nbsp; <strong>Nuevo profesor: </strong> Se agrego correctamente el nuevo profesor
...
?>                           
                        <tr>  
                            ...
                            <td>
                                <a href="detalleProfesor.php?id=<?php echo $row['id'] ?>" class="btn btn-success"><i class="fa fa-pencil"></i> Detalles</a>
                            </td>
                        </tr>
<?php endwhile; ?>                        
                    </tbody>
