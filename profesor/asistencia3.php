<?php 
    ...
    $sql_asistencia="SELECT `fecha` AS `fecha`, DATE_FORMAT(`entrada`,'%H:%i') AS `entrada`, DATE_FORMAT(`salida`,'%H:%i') AS `salida` FROM `asistencia` WHERE `id`='$idas'";
    $query_asis = mysqli_query($con, $sql_asistencia);
    $row_asis = mysqli_fetch_array($query_asis);
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  class="form-horizontal" name="nuevo" action="asistenciag2.php?id=<?php echo $id?>&ida=<?php echo $id_a?>" method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <strong><?php echo $row_asis['fecha']?></strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                 <strong><?php echo $row_asis['entrada']?></strong>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                 <strong><?php echo $row_asis['salida']?></strong>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <a href="asistenciag3.php?id=<?php echo $id?>&idas=<?php echo $idas?>" class="btn-danger btn"><i class="fa fa-trash-o"></i> Eliminar</a>
                            <a href="asistenciaTaller.php?id=<?php echo $id ?>" class="btn-default btn"><i class="fa fa-mail-reply"></i> Cancelar</a>
                        </div>
                    </div>
                </div>
                </form>
