...
<!-- fin de cabecera -->
        ...
        <div class="options">
            <div class="btn-toolbar">              
                ...
                <a href="taller2.php?id=<?php echo $id ?>" class="btn btn-success"><i class="fa fa-edit"></i> EDITAR TALLER</a>
...
?>  
                        <tr>                            
                            ...
                            <td>
                                 <a href="eliminarAlumno.php?id=<?php echo $id; ?>&ida=<?php echo $rowc['ida']?>&idi=<?php echo $rowc['id']?>" class="btn btn-danger"><i class="fa fa-times-circle-o"></i></a>
                            </td>
