<?php 
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de eliminar disciplina: ".$row['disiplina']);    
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <a href="disg3.php?id=<?php echo $id;?>" class="btn-danger btn"><i class="fa fa-trash-o"></i> Eliminar</a>
