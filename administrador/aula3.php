<?php 
    ...
    $id = intval($_GET['id']);        
    $sql = "SELECT * FROM `aula` WHERE `estado` = '1'  AND `id`='$id'; ";
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de eliminar ubicacion: ".$row['detalle']);    
    #cerramos la funcion
    $log->close();
    ...
    <div class="col-sm-12">
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <form  class="form-horizontal" name="nuevo" action="aulag1.php" method="post" >
                    <div class="form-group">
                        <label class="col-md-2 control-label">Ubicacioón:</label>
                        <div class="col-md-8">
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <a href="aulag3.php?id=<?php echo $id ?>" class="btn-danger btn"><i class="fa fa-trash-o"></i> Eliminar</a>
                            <a href="aula.php" class="btn-default btn"><i class="fa fa-mail-reply"></i> Cancelar</a>
                        </div>
                    </div>
                </div>
                </form>
