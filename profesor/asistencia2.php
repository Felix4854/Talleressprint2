    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  class="form-horizontal" name="nuevo" action="asistenciag2.php?id=<?php echo $id?>&ida=<?php echo $id_a?>&idas=<?php echo $idas?>" method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="date" name="fecha" value="<?php echo $row_asis['fecha']?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                 <input type="time" name="ingreso" value="<?php echo $row_asis['entrada']?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                 <input type="time" name="salida" value="<?php echo $row_asis['salida']?>">
                            </div>
                        </div>
                    </div>
