<?php 
    ...
    $id = $_GET['id']; 
    $sql3 = "SELECT `taller` FROM `taller` WHERE `id`='$id';";
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de eliminar el taller: ".$rowc['taller'] );
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
    ...
    <div class="col-sm-12">
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <form  class="form-horizontal" name="nuevo" action="tallg1.php" method="post" >
                    <div class="form-group">
                        <label class="col-md-2 control-label">Nombre del Taller:</label>
                        <div class="col-md-8">                            
                                <?php echo $rowc['taller'] ?>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <a href="tallg3.php?id=<?php echo $id;?>" class="btn-danger btn"><i class="fa fa-trash-o"></i> Eliminar</a>
