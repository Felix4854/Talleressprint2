<?php 
    ...
    $sql = "SELECT * FROM `disiplina` WHERE `estado`=1 ";
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de disciplinas");    
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
...
<!-- fin de cabecera -->
    ...
    <div class="page-heading">            
        <h1><i class="fa fa-book"></i> Gestión de Disciplinas</h1>
        <div class="options">
            <div class="btn-toolbar">              
                <a href="disciplina1.php" class="btn btn-success"><i class="fa fa-plus-circle"></i> NUEVA DISCIPLINA</a>
            </div>
        </div>
    </div>
...
<?php if (isset($_GET['r']) AND $_GET['r']==1){ ?>                                  
    <div class="alert alert-dismissable alert-success">
        <i class="fa fa-fw fa-check"></i>&nbsp; <strong>Nuevo registro: </strong> Se agrego correctamente la nueva disciplina
...
?> 
                        <tr>                            
                            ...
                            <td>
                                <a href="disciplina2.php?id=<?php echo $row['id'] ?>" class="btn btn-success"><i class="fa fa-pencil"></i> editar</a>
                            </td>
                            <td>
                                <a href="disciplina3.php?id=<?php echo $row['id'] ?>" class="btn btn-danger"><i class="fa fa-times-circle-o"></i> eliminar</a>
                            </td>
                        </tr>
<?php endwhile; ?>                        
                    </tbody>
