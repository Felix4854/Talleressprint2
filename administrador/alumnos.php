<?php 
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de alumnos");    
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
    ...
    <div class="page-heading">            
        ...
        <div class="options">
            <div class="btn-toolbar">              
                <a href="alumno1.php" class="btn btn-success"><i class="fa fa-plus-circle"></i> NUEVO ALUMNO</a>
            </div>
        </div>
    </div>
...
<?php if (isset($_GET['r']) AND $_GET['r']==0){ ?>
    <div class="alert alert-dismissable alert-success">
        <i class="fa fa-fw fa-check"></i>&nbsp; <strong>Nuevo alumno: </strong> Se agrego correctamente el nuevo alumno
...
?>                         
                        <tr>                            
                            ...
                            <td>
                                <a href="detalleAlumno.php?id=<?php echo $row['id'] ?>" class="btn btn-success"><i class="fa fa-pencil"></i> Detalles</a>
                            </td>
                        </tr>
<?php endwhile; ?>                        
                    </tbody>
