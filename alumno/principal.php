<?php 
    ...
    $con = connection();    
    //datos del alumno:
    $sql_alumno="SELECT  `dni`,`nombres`, `correo` FROM `alumno` WHERE `id`='$id_alumno';";
    $slq_query= mysqli_query($con, $sql_alumno);
            ...
            <div class="panel-body">
                <div class="tab-content">
                    <div class="tab-pane active" id="dominfotiles">
                        <div class="row">
                           <h1>Bienvenido: <strong><?php echo $row['nombres']?></strong></h1>
                           <h2>DNI: <strong><?php echo $row['dni']?></strong> | Correo: <strong><?php echo $row['correo']?></strong></h2>
                            <div class="col-md-6">
                                <a class="info-tile tile-midnightblue" href="detalleAlumno.php?id=<?php echo $id_alumno?>">
                                    ...
                                    <div class="tile-body">
                                        ...
                                        <div class="pull-right">Talleres Inscritos</div>
                                    </div>
                                </a>
                            </div>
                        </div>
