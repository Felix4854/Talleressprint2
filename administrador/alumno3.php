<?php 
    ...
    #iniciando
    $log = new Log("log.txt");
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de eliminar el alumno: ".$row['nombres']);
    #cerramos la funcion
    $log->close();    
    ...
    <div class="col-sm-12">
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                ...
                <form  class="form-horizontal" name="nuevo"  method="post" >
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            <a href="almg3.php?id=<?php echo $id ?>" class="btn-danger btn"><i class="fa fa-trash-o"></i> Eliminar</a>
                            <a href="detalleAlumno.php?id=<?php echo $id ?>" class="btn-default btn"><i class="fa fa-mail-reply"></i> Cancelar</a>
                        </div>
                    </div>
                </div>
                </form>
