				...
				<div class="panel-body">					
					<form action="login.php" class="form-horizontal"  method="post" >
						<div class="form-group">
	                        <div class="col-xs-12">
	                        	<div class="input-group">							
									...
									<input type="text" class="form-control" placeholder="Usuario" data-parsley-minlength="6" placeholder="At least 6 characters" required name="usuario">
								</div>
	                        </div>
						</div>
						<div class="form-group">
						...
						<div class="panel-footer">
							<div class="clearfix">
								<button type="submit" class="btn-success btn"><i class="fa fa-check-circle-o"></i> Ingresar</button>
							</div>
						</div>
