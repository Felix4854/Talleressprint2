<?php 
    ...
    $sql = "SELECT * FROM `aula` WHERE `estado` = '1' ";
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de Ubicación");    
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
...
<!-- fin de cabecera -->
    ...
    <div class="page-heading">            
        <h1><i class="fa fa-group"></i> Gestión de Ubicaciones</h1>
        <div class="options">
            <div class="btn-toolbar">              
                <a href="aula1.php" class="btn btn-success"><i class="fa fa-plus-circle"></i> NUEVA UBICACIÓN</a>
            </div>
        </div>
    </div>
...
<?php if (isset($_GET['r']) AND $_GET['r']==1){ ?>                                        
    <div class="alert alert-dismissable alert-success">
        <i class="fa fa-fw fa-check"></i>&nbsp; <strong>Nueva aula: </strong> Se agrego correctamente la nueva aula
...
?>  
                        <tr>                            
                            ...
                            <td>
                                <a href="aula2.php?id=<?php echo $row['id'] ?>" class="btn btn-success"><i class="fa fa-pencil"></i> editar</a>
                            </td>
                            <td>
                                <a href="aula3.php?id=<?php echo $row['id'] ?>" class="btn btn-danger"><i class="fa fa-times-circle-o"></i> eliminar</a>
                            </td>
                        </tr>
<?php endwhile; ?>                        
                    </tbody>
