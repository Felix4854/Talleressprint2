<?php 
    ...
    #iniciando
    $log = new Log("log.txt");
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de editar el alumno: ".$row['nombres']);
    #cerramos la funcion
    $log->close();    
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form  class="form-horizontal" name="nuevo" action="almg2.php?id=<?php echo $id ?>" method="post" >
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <a href="detalleAlumno.php?id=<?php echo $row['id']?>" class="btn-default btn"><i class="fa fa-mail-reply"></i> Cancelar</a>
                        </div>
                    </div>
                </div>
                </form>
