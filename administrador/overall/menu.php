        ...
        <div class="sidebar">   
            <div class="widget stay-on-collapse" id="widget-sidebar">
                <nav role="navigation" class="widget-body">
                    <ul class="acc-menu">       
                        <li><a href="principal.php"><i class="fa fa-home"></i><span>Inicio</span></a></li>
                        <li><a href="disciplina.php"><i class="fa fa-book"></i><span>Disciplina</span></a></li>
                        <li><a href="profesor.php"><i class="fa fa-mortar-board"></i><span>Profesores</span></a></li>
                        <li><a href="aula.php"><i class="fa fa-bank"></i><span>Ubicación</span></a></li>
