<?php 
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de editar la ubicacion: ".$row['detalle']);    
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  class="form-horizontal" name="nuevo" action="aulag2.php?id=<?php echo $id?>" method="post" >
                    <div class="form-group">
                        <label class="col-md-2 control-label">Ubicacioón:</label>
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" class="form-control"  name="aula" value="<?php echo $row['detalle'] ?>">
                            </div>
                        </div>
                    </div>
