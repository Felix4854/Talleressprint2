<?php 
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area de nueva disciplina");    
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
...
<?php } ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form  class="form-horizontal" name="nuevo" action="disg1.php" method="post" >
