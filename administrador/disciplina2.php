<?php 
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM `disiplina` WHERE `estado`=1 AND `id`='$id'  ";
    ...
    $log->writeLine("usuario: ".$_SESSION['us_nm']."][Informacion", "ingreso al area editar disciplina: " .$row['disiplina']);    
    #cerramos la funcion
    $log->close();
?>
<!DOCTYPE html>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form  class="form-horizontal" name="nuevo" action="disg2.php?id=<?php echo $id?>" method="post" >
                    <div class="form-group">
                        <label class="col-md-2 control-label">Disciplina:</label>
                        <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" class="form-control"  name="disciplina" value="<?php echo $row['disiplina']?>">
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <a href="disciplina.php" class="btn-default btn"><i class="fa fa-mail-reply"></i> Cancelar</a>
                        </div>
                    </div>
                </div>
                </form>
