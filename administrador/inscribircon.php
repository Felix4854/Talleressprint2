<?php 
    ...
    $sqlAlumnos = "SELECT `dni`, `nombres` FROM `alumno` WHERE `estado`='1' AND `id`='$ida';";
    $query_alum=mysqli_query($con, $sqlAlumnos);
    $row_al = mysqli_fetch_array($query_alum)
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- fin de cabecera -->
        ...
        <div class="options">
            <div class="btn-toolbar">              
                <a href="inscribir.php?id=<?php echo $id ?>" class="btn btn-info"><i class="fa  fa-reply"></i> REGRESAR</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  class="form-horizontal" name="nuevo" action="inscritog1.php?id=<?php echo $id?>&ida=<?php echo $ida ?> " method="post" >
                    <div class="form-group">
                        <label class="col-md-2 control-label">Alumno</label>
                        <div class="col-md-8">
                            <div class="input-group">
                                <strong><?php echo $row_al['nombres']; ?></strong>
                            </div>
                        </div>
                    </div>
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <a href="inscribir.php?id=<?php echo $id ?>" class="btn-default btn"><i class="fa fa-mail-reply"></i> Cancelar</a>
                        </div>
                    </div>
                </div>
                </form>
